...
**Note:** Before doing this, make sure you open the Verida Vault and connect Facebook and / or Twitter to syncronize your social media posts. This can be done vai the "Connections" navigation item in the bottom left of the home screen.
