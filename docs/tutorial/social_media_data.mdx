...
**Note:** Before doing this, make sure you open the Verida Vault and connect Facebook and / or Twitter to syncronize your social media posts. This can be done via the "Connections" navigation item in the bottom left of the home screen.
...
VeridaRequestDataExample = () => {
  ...
  requestSocialData = async function () {
      ...
      setStatus("Request sent. Please check the Vault and share your social data")
  ...
  if (veridaContext) {
    ...
    return (
      <div>
        Please make sure you have connected Facebook and / or Twitter to your Verida Vault. 
        <br />
