...
VeridaLoginExample = () => {
  ...
  if (veridaContext) {
    ...
    return (
      <div>
        <h3>Logged in! Your <a href="/docs/concepts/accounts-and-identity">DID</a> 
        is: <pre>{veridaContext.account.accountDid}</pre></h3>
...
* [VaultAccount](https://developers.verida.io/docs/api/verida-js/classes/verida_account_web_vault.VaultAccount)
* [VaultAccountConfig](https://developers.verida.io/docs/api/verida-js/interfaces/verida_account_web_vault.VaultAccountConfig)
