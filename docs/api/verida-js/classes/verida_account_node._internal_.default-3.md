...
- [asymKeyPair](verida_account_node._internal_.default-3.md#asymkeypair)
- [buildKey](verida_account_node._internal_.default-3.md#buildkey)
- [seed](verida_account_node._internal_.default-3.md#seed)
- [signKeyPair](verida_account_node._internal_.default-3.md#signkeypair)
- [storageContextKeys](verida_account_node._internal_.default-3.md#storagecontextkeys)
- [symKey](verida_account_node._internal_.default-3.md#symkey)

### Methods

- [\_init](verida_account_node._internal_.default-3.md#_init)
- [asymDecrypt](verida_account_node._internal_.default-3.md#asymdecrypt)
- [asymEncrypt](verida_account_node._internal_.default-3.md#asymencrypt)
- [buildSharedKeyEnd](verida_account_node._internal_.default-3.md#buildsharedkeyend)
- [buildSharedKeyStart](verida_account_node._internal_.default-3.md#buildsharedkeystart)
- [getKeys](verida_account_node._internal_.default-3.md#getkeys)
- [getSeed](verida_account_node._internal_.default-3.md#getseed)
- [getStorageContextKey](verida_account_node._internal_.default-3.md#getstoragecontextkey)
- [publicKeys](verida_account_node._internal_.default-3.md#publickeys)
- [sign](verida_account_node._internal_.default-3.md#sign)
- [symDecrypt](verida_account_node._internal_.default-3.md#symdecrypt)
- [symEncrypt](verida_account_node._internal_.default-3.md#symencrypt)
