[root](../README.md) / [Modules](../modules.md) / [@verida/did-document](../modules/verida_did_document.md) / [<internal\>](../modules/verida_did_document._internal_.md) / default

# Class: default

[@verida/did-document](../modules/verida_did_document.md).[<internal\>](../modules/verida_did_document._internal_.md).default
...
- [constructor](verida_did_document._internal_.default.md#constructor)

### Properties

- [asymKeyPair](verida_did_document._internal_.default.md#asymkeypair)
- [buildKey](verida_did_document._internal_.default.md#buildkey)
- [seed](verida_did_document._internal_.default.md#seed)
- [signKeyPair](verida_did_document._internal_.default.md#signkeypair)
- [storageContextKeys](verida_did_document._internal_.default.md#storagecontextkeys)
- [symKey](verida_did_document._internal_.default.md#symkey)

### Methods

- [\_init](verida_did_document._internal_.default.md#_init)
- [asymDecrypt](verida_did_document._internal_.default.md#asymdecrypt)
- [asymEncrypt](verida_did_document._internal_.default.md#asymencrypt)
- [buildSharedKeyEnd](verida_did_document._internal_.default.md#buildsharedkeyend)
- [buildSharedKeyStart](verida_did_document._internal_.default.md#buildsharedkeystart)
- [getKeys](verida_did_document._internal_.default.md#getkeys)
- [getSeed](verida_did_document._internal_.default.md#getseed)
- [getStorageContextKey](verida_did_document._internal_.default.md#getstoragecontextkey)
- [publicKeys](verida_did_document._internal_.default.md#publickeys)
- [sign](verida_did_document._internal_.default.md#sign)
- [symDecrypt](verida_did_document._internal_.default.md#symdecrypt)
- [symEncrypt](verida_did_document._internal_.default.md#symencrypt)
- [verifySig](verida_did_document._internal_.default.md#verifysig)
