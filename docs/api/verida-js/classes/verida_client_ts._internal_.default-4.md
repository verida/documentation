...
- [RULES](verida_client_ts._internal_.default-4.md#rules)
- [\_cache](verida_client_ts._internal_.default-4.md#_cache)
- [\_checkUnique](verida_client_ts._internal_.default-4.md#_checkunique)
- [\_compilations](verida_client_ts._internal_.default-4.md#_compilations)
- [\_compileMetaSchema](verida_client_ts._internal_.default-4.md#_compilemetaschema)
- [\_compileSchemaEnv](verida_client_ts._internal_.default-4.md#_compileschemaenv)
- [\_loading](verida_client_ts._internal_.default-4.md#_loading)
- [\_metaOpts](verida_client_ts._internal_.default-4.md#_metaopts)
- [\_removeAllSchemas](verida_client_ts._internal_.default-4.md#_removeallschemas)
- [errors](verida_client_ts._internal_.default-4.md#errors)
- [formats](verida_client_ts._internal_.default-4.md#formats)
- [logger](verida_client_ts._internal_.default-4.md#logger)
- [opts](verida_client_ts._internal_.default-4.md#opts)
- [refs](verida_client_ts._internal_.default-4.md#refs)
- [schemas](verida_client_ts._internal_.default-4.md#schemas)
- [scope](verida_client_ts._internal_.default-4.md#scope)
- [MissingRefError](verida_client_ts._internal_.default-4.md#missingreferror)
- [ValidationError](verida_client_ts._internal_.default-4.md#validationerror)

### Methods

- [$dataMetaSchema](verida_client_ts._internal_.default-4.md#$datametaschema)
- [\_addDefaultMetaSchema](verida_client_ts._internal_.default-4.md#_adddefaultmetaschema)
- [\_addSchema](verida_client_ts._internal_.default-4.md#_addschema)
- [\_addVocabularies](verida_client_ts._internal_.default-4.md#_addvocabularies)
- [addFormat](verida_client_ts._internal_.default-4.md#addformat)
- [addKeyword](verida_client_ts._internal_.default-4.md#addkeyword)
- [addMetaSchema](verida_client_ts._internal_.default-4.md#addmetaschema)
- [addSchema](verida_client_ts._internal_.default-4.md#addschema)
- [addVocabulary](verida_client_ts._internal_.default-4.md#addvocabulary)
- [compile](verida_client_ts._internal_.default-4.md#compile)
- [compileAsync](verida_client_ts._internal_.default-4.md#compileasync)
- [defaultMeta](verida_client_ts._internal_.default-4.md#defaultmeta)
- [errorsText](verida_client_ts._internal_.default-4.md#errorstext)
- [getKeyword](verida_client_ts._internal_.default-4.md#getkeyword)
- [getSchema](verida_client_ts._internal_.default-4.md#getschema)
- [removeKeyword](verida_client_ts._internal_.default-4.md#removekeyword)
- [removeSchema](verida_client_ts._internal_.default-4.md#removeschema)
- [validate](verida_client_ts._internal_.default-4.md#validate)
- [validateSchema](verida_client_ts._internal_.default-4.md#validateschema)
