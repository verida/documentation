[root](../README.md) / [Modules](../modules.md) / [@verida/vda-sbt-client](../modules/verida_vda_sbt_client.md) / [<internal\>](../modules/verida_vda_sbt_client._internal_.md) / Result

# Interface: Result

[@verida/vda-sbt-client](../modules/verida_vda_sbt_client.md).[<internal\>](../modules/verida_vda_sbt_client._internal_.md).Result
...
- [length](verida_vda_sbt_client._internal_.Result.md#length)

### Methods

- [[iterator]](verida_vda_sbt_client._internal_.Result.md#[iterator])
- [concat](verida_vda_sbt_client._internal_.Result.md#concat)
- [entries](verida_vda_sbt_client._internal_.Result.md#entries)
- [every](verida_vda_sbt_client._internal_.Result.md#every)
- [filter](verida_vda_sbt_client._internal_.Result.md#filter)
- [find](verida_vda_sbt_client._internal_.Result.md#find)
- [findIndex](verida_vda_sbt_client._internal_.Result.md#findindex)
- [flat](verida_vda_sbt_client._internal_.Result.md#flat)
- [flatMap](verida_vda_sbt_client._internal_.Result.md#flatmap)
- [forEach](verida_vda_sbt_client._internal_.Result.md#foreach)
- [includes](verida_vda_sbt_client._internal_.Result.md#includes)
- [indexOf](verida_vda_sbt_client._internal_.Result.md#indexof)
- [join](verida_vda_sbt_client._internal_.Result.md#join)
- [keys](verida_vda_sbt_client._internal_.Result.md#keys)
- [lastIndexOf](verida_vda_sbt_client._internal_.Result.md#lastindexof)
- [map](verida_vda_sbt_client._internal_.Result.md#map)
- [reduce](verida_vda_sbt_client._internal_.Result.md#reduce)
- [reduceRight](verida_vda_sbt_client._internal_.Result.md#reduceright)
- [slice](verida_vda_sbt_client._internal_.Result.md#slice)
- [some](verida_vda_sbt_client._internal_.Result.md#some)
- [toLocaleString](verida_vda_sbt_client._internal_.Result.md#tolocalestring)
- [toString](verida_vda_sbt_client._internal_.Result.md#tostring)
- [values](verida_vda_sbt_client._internal_.Result.md#values)
...
▸ **[iterator]**(): [`IterableIterator`](verida_vda_sbt_client._internal_.IterableIterator.md)<`any`\>

Iterator of values in the array.

#### Returns

[`IterableIterator`](verida_vda_sbt_client._internal_.IterableIterator.md)<`any`\>

#### Inherited from

ReadonlyArray.\_\_@iterator@17093
...
| :------ | :------ | :------ |
| `...items` | [`ConcatArray`](verida_vda_sbt_client._internal_.ConcatArray.md)<`any`\>[] | Additional items to add to the end of array1. |
...
▸ **entries**(): [`IterableIterator`](verida_vda_sbt_client._internal_.IterableIterator.md)<[`number`, `any`]\>

Returns an iterable of key, value pairs for every entry in the array

#### Returns

[`IterableIterator`](verida_vda_sbt_client._internal_.IterableIterator.md)<[`number`, `any`]\>
...
▸ **flat**<`A`, `D`\>(`depth?`): [`FlatArray`](../modules/verida_vda_sbt_client._internal_.md#flatarray)<`A`, `D`\>[]
...
[`FlatArray`](../modules/verida_vda_sbt_client._internal_.md#flatarray)<`A`, `D`\>[]
...
▸ **keys**(): [`IterableIterator`](verida_vda_sbt_client._internal_.IterableIterator.md)<`number`\>

Returns an iterable of keys in the array

#### Returns

[`IterableIterator`](verida_vda_sbt_client._internal_.IterableIterator.md)<`number`\>
...
▸ **values**(): [`IterableIterator`](verida_vda_sbt_client._internal_.IterableIterator.md)<`any`\>
