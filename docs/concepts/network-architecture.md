...
- **Identity:** Allows users to create new decentralized identities, blockchain wallets, manage their private keys and facilitate verida connect across an ecosystem of decentralized apps.
- **Verida Connect:** Simple, consensual authentication and authorization with decentralized applications developed on the Verida network.
...
A decentralized Verida Connect SDK that enables seamless QR code authentication via the Verida Vault mobile application.
