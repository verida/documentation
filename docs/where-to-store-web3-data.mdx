...
Verida exists to solve these problems. The Verida DbStore is a decentralized, end-to-end (E2E) encrypted document database.
...
Verida DbStore is a new type of Web3 storage that provides capabilities that are important to many applications. It is fast, resilient and easy to use. Check it out at verida.io.
